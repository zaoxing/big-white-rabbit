...
private struct HeroCard: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            // bwr mark as the Dock icon and README hero, light/dark
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(String(localized: "about.hero.tagline",
                            ...
                            comment: "Tagline shown under the BigWhiteRabbit product name on the About screen hero card"))
                    .font(.bwrText(12))
        ...
        ListGroup {
            LinkRow(
                label: String(localized: "about.project.github.label",
                              ...
                              comment: "About screen link row label pointing to the BigWhiteRabbit GitHub repo"),
            ...
            FreeRow(isLast: true) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text(String(localized: "about.license.notice",
                                defaultValue: "Copyright © BigWhiteRabbit contributors. Licensed under the Apache License, Version 2.0. See the LICENSE file in the repository for the full text.",
