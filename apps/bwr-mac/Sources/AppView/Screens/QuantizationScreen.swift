...
// (bwr/admin/templates/dashboard/_models.html:1025-1280 + dashboard.js:3437-
...
//                            "app.bwr.hf-upload"); never persisted to
        ...
        VStack(alignment: .leading, spacing: 0) {
            ScreenHeader(
                ...
                subtitle: String(localized: "quant.header.subtitle",
                                 defaultValue: "Pick a full-precision model, choose an oQ level, and BigWhiteRabbit builds a mixed-precision plan tuned to that model's per-layer sensitivity. Output is standard mlx-lm safetensors — usable in any MLX runtime.",
            ...
            Button {
                ...
                HStack(spacing: 6) {
                    ...
                    Text(String(localized: "quant.advanced.title",
                        ...
                        .font(.bwrText(11, weight: .semibold))
                        .foregroundStyle(theme.textSecondary)
                        .textCase(.uppercase)
                        .kerning(0.6)
                    Spacer(minLength: 0)
...
private struct StatusChip: View {
    ...
    var body: some View {
        ...
        Text(cfg.1)
            .font(.bwrText(10, weight: .semibold))
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text(String(localized: "quant.upload_modal.title",
                    ...
                    .font(.bwrText(15, weight: .semibold))
                    .foregroundStyle(theme.text)
                Text(task.outputName)
                    .font(.bwrMono(11.5))
                    .foregroundStyle(theme.textSecondary)
    ...
    private var footer: some View {
        HStack(spacing: 8) {
            ...
            Button(String(localized: "common.cancel",
                ...
                .buttonStyle(.bwr(.normal, size: .regular))
...
private struct AboutSection: View {
            ...
            VStack(alignment: .leading, spacing: 10) {
                Text(
                    String(localized: "quant.about.intro_title",
                        defaultValue: "oQ: BigWhiteRabbit Universal Dynamic Quantization",
                        comment: "Large heading inside the expanded About oQ card")
                )
                .font(.bwrText(16, weight: .bold))
                .foregroundStyle(theme.text)
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        quote(
                            String(localized: "quant.about.quote.works_everywhere",
                                defaultValue: "oQ produces standard mlx-lm models that work everywhere — BigWhiteRabbit, mlx-lm, LM Studio, and any app that supports MLX safetensors format.",
                                comment: "Quoted line inside the About oQ card")
                        )
                        quote(
    ...
    private func quote(_ value: String) -> some View {
        Text(value)
            .font(.bwrText(11.5, weight: .semibold))
            .italic()
            .foregroundStyle(theme.textSecondary)
            .fixedSize(horizontal: false, vertical: true)
    }
    ...
    private func tableCell(_ value: String, header: Bool = false) -> some View {
        Text(value)
            .font(.bwrText(10.5, weight: header ? .semibold : .regular))
...
enum Keychain {
    private static let service = "app.bwr.hf-upload"
