...
final class ModelSettingsScreenVM {
    ...
    func load(modelID: String, client: BWRClient) async {
    ...
    func save(_ field: Field, client: BWRClient) async {
    ...
    func startANETuning(client: BWRClient) async {
        ...
        do {
            ...
            aneTuningIsRunning = false
            lastError = error.bwrDescription
        }
    }

    func cancelANETuning(client: BWRClient) async {
    ...
    /// server templates.
    func applyChip(scope: ProfileScope, name: String, client: BWRClient) async {
        do {
            switch scope {
            case .preset:
    ...
    func renameTemplate(from original: String, to renamed: String, client: BWRClient) async {
        do {
    ...
    func renameModelProfile(from original: String, to renamed: String, client: BWRClient) async {
        do {
    ...
    func setExposeAsModel(name: String, exposed: Bool, client: BWRClient) async {
        do {
            _ = try await client.updateModelProfile(
                id: modelID,
                name: name,
    ...
    /// first apply.
    func applyPreset(_ entry: PresetEntry, client: BWRClient) async {
        do {
    ...
    func saveWorkingAs(scope: ProfileScope, name: String, client: BWRClient) async {
    ...
    func updateProfileWithWorking(scope: ProfileScope, name: String, client: BWRClient) async {
    ...
    func revertWorking(client: BWRClient) async {
        await load(modelID: modelID, client: client)
    }
    ...
    func applyProfile(name: String, client: BWRClient) async {
        do {
            _ = try await client.applyModelProfile(id: modelID, name: name)
            await load(modelID: modelID, client: client)
        } catch {
    ...
    func createProfile(name: String, client: BWRClient) async {
        do {
            _ = try await client.createModelProfile(
                id: modelID,
                body: CreateProfileRequest(
    ...
    func deleteProfile(name: String, client: BWRClient) async {
    ...
    func applyTemplate(template: ProfileDTO, client: BWRClient) async {
        do {
            _ = try await client.createModelProfile(
                id: modelID,
                body: CreateProfileRequest(
