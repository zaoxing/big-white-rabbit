...
final class ModelsScreenVM {
    ...
    func load(id: String, client: BWRClient) {
        Task { [weak self] in
            do {
    ...
    func unload(id: String, client: BWRClient) {
        Task { [weak self] in
            do {
    ...
    func setFavorite(id: String, favorite: Bool, client: BWRClient) {
        Task { [weak self] in
            do {
    ...
    func remove(id: String, client: BWRClient) {
        pendingRemoveID = nil
        deletingID = id
        Task { [weak self] in
