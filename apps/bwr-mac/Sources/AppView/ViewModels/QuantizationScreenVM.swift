...
final class QuantizationScreenVM {
    ...
    func scheduleEstimateRefresh(client: BWRClient) {
    ...
    func startQuantization(client: BWRClient) {
    ...
    func cancelTask(taskId: String, client: BWRClient) {
        Task { [weak self] in
            do {
    ...
    func removeTask(taskId: String, client: BWRClient) {
        Task { [weak self] in
            do {
    ...
    func validateUploadToken(client: BWRClient) async {
        ...
        do {
            ...
            self.lastUploadError = String(localized: "quant.upload.error.validate_failed",
                                          defaultValue: "Validate failed: \(error.bwrDescription)",
    ...
    func startUpload(body: HFUploadStartRequest, client: BWRClient) async {
        lastUploadError = nil
        do {
    ...
    func removeUpload(taskId: String, client: BWRClient) {
        Task { [weak self] in
            do {
