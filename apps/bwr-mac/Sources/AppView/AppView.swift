...
// hosted in the SwiftUI `Window` scene declared in `BigWhiteRabbitApp.swift`.
        ...
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text(String(localized: "update.confirm.title",
                            defaultValue: "BigWhiteRabbit \(update.version) is available",
                            comment: "Update confirmation sheet title; placeholder is the version"))
                    .font(.bwrText(17, weight: .semibold))
        ...
        HStack(spacing: 10) {
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text(String(localized: "update.confirm.restart_notice",
                            defaultValue: "BigWhiteRabbit will quit, install the update, and relaunch.",
...
/// Mirrors `ContentArea` from the design (bwr-components.jsx:250-292):
