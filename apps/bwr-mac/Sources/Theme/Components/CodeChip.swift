...
struct CodeChip: View {
    ...
    var body: some View {
        Button(action: copy) {
            HStack(spacing: 6) {
                Text(value)
                    .font(.bwrMono(11.5, weight: .medium))
...
#Preview("CodeChip") {
    VStack(alignment: .leading, spacing: 10) {
        CodeChip(value: "http://127.0.0.1:1919/v1")
        CodeChip(value: "http://127.0.0.1:1919/health")
        CodeChip(value: "OPENAI_BASE_URL=http://127.0.0.1:1919/v1", maxWidth: 280)
