...
//
// Throughput mirrors bwr/admin/routes.py:/api/bench/* (start @4619,
...
///
/// The server always publishes results to the public bwr.ai
...
struct BenchResultsResponse: Codable, Sendable {
    ...
    /// (bwr/admin/benchmark.py:_upload_to_bwr_ai). Populated server-side
