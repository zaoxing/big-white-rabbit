...
//
// The server's MS downloader (`bwr/admin/ms_downloader.py:19`) imports
...
// `MSDownloadRequest` (bwr/admin/routes.py:287-291) uses `model_id` /
...
/// flag in `bwr/server.py:1278`). The Downloads tab gates the MS branch
