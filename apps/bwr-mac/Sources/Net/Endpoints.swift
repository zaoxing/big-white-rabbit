...
// PR 7 screens. Kept separate from `BWRClient.swift` so PR 8/9 can grow this
// file without churning the client itself.
//
// The actual `getX()` methods live as extensions on `BWRClient` (see
// `BWRClient.swift`). This file is the canonical list of paths so future
...
enum AdminAPI {
    ...
    /// Proxy that fetches the remote preset bundle from bwr.ai and returns
