...
// itself.
//
// PR 7's BWRClient will absorb this auth machinery; for now the poller owns
...
final class MenubarStatsPoller {
    static let didUpdateNotification = Notification.Name("BWRMenubarStatsDidUpdate")
    ...
    init(
        ...
        // jar — matches BWRClient and inherits its login session.
