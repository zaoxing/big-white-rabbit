...
final class AppServicesPathTests: XCTestCase {
    ...
    func testRelocateOutsideTreeIsUnchanged() {
        XCTAssertEqual(
            AppServices.relocate(path: "/Volumes/SSD/models",
                                 oldBase: "/Users/Fido/.bwr",
                                 newBase: "/Users/Fido/.bwr-other"),
            "/Volumes/SSD/models"
        )
    }
    ...
    func testRelocateTildeIsExpanded() {
        ...
        XCTAssertEqual(
            AppServices.relocate(path: "~/.bwr/models",
                                 oldBase: "\(home)/.bwr",
                                 newBase: "\(home)/.bwr-other"),
            "\(home)/.bwr-other/models"
        )
    }
    ...
    private func makeTempSettingsFile(contents: [String: Any]) throws -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("BigWhiteRabbitTests-\(UUID().uuidString)")
    ...
    func testRelocateOrphanPathsHappyPath() throws {
        let url = try makeTempSettingsFile(contents: [
            "model": [
                "model_dirs": ["/Users/Fido/.bwr-other/models"],
                "model_dir": "/Users/Fido/.bwr-other/models",
                "max_model_memory": "auto"
            ],
            "cache": [
                "ssd_cache_dir": "/Users/Fido/.bwr-other/cache",
                "enabled": true
            ],
            "logging": [
                "log_dir": "/Users/Fido/.bwr-other/logs",
                "retention_days": 7
            ],
        ...
        try AppServices.relocateOrphanPaths(
            in: url,
            oldBase: "/Users/Fido/.bwr-other",
            newBase: "/Users/Fido/.bwr"
        )

        let after = try readJSON(url)
        let model = after["model"] as! [String: Any]
        XCTAssertEqual(model["model_dirs"] as! [String], ["/Users/Fido/.bwr/models"])
        XCTAssertEqual(model["model_dir"] as! String, "/Users/Fido/.bwr/models")
        ...
        XCTAssertEqual(cache["ssd_cache_dir"] as! String, "/Users/Fido/.bwr/cache")
        XCTAssertEqual(cache["enabled"] as! Bool, true)

        let logging = after["logging"] as! [String: Any]
        XCTAssertEqual(logging["log_dir"] as! String, "/Users/Fido/.bwr/logs")
