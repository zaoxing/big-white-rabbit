...
final class UpdateInstallerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        temporaryDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("bwr update $HOME \"quoted\" \(UUID().uuidString)")
    ...
    func testWorkerRequestPreservesPathsWithoutShellParsing() throws {
        let live = temporaryDirectory.appendingPathComponent("BigWhiteRabbit.app")
        ...
        let request = try XCTUnwrap(UpdateInstaller.workerRequest(from: [
            "/Applications/BigWhiteRabbit.app/Contents/MacOS/BigWhiteRabbit",
    ...
    func testLaunchAgentRunsOnceWithoutKeepAlive() throws {
        ...
        let executable = live.appendingPathComponent("Contents/MacOS/BigWhiteRabbit")

        let plist = UpdateInstaller.launchAgentPropertyList(
            label: "app.bwr.updater.test",
    ...
    func testAtomicSwapExchangesCompleteBundles() throws {
        let live = try makeBundle(name: "BigWhiteRabbit.app", marker: "old")
