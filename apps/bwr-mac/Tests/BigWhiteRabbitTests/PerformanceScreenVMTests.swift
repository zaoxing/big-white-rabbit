...
final class PerformanceScreenVMTests: XCTestCase {
    ...
    private func systemInfo(
        ...
        GlobalSettingsDTO.SystemInfo(
            ...
            totalMemory: nil,
            bwrPhysFootprintBytes: Int64(bwrGB * Self.gb),
            ...
            bwrWiredLimitRequestBytes: Int64(requestGB * Self.gb)
        )
    }
    ...
    func testBalancedTierBreakdownSumsReclaimLayers() throws {
        // dynamic = bwr 6 + free 8 + inactive 4 + active 10 * 0.5 = 23;
        // static = 48 - 6 = 42, metal 36 -> dynamic binds at 23.
        let vm = makeVM(
            tier: "balanced",
            info: systemInfo(
                totalGB: 48, metalCapGB: 36, requestGB: 36,
                freeGB: 8, inactiveGB: 4, activeGB: 10, bwrGB: 6
            )
        )
    ...
    func testSystemInfoDecodesSnakeCaseMemoryFields() throws {
        let json = """
        {
            ...
            "bwr_phys_footprint_bytes": 1073741824,
            ...
            "bwr_wired_limit_request_bytes": 49392123904
        }
        """
        ...
        XCTAssertEqual(sys.bwrPhysFootprintBytes, 1073741824)
        ...
        XCTAssertEqual(sys.bwrWiredLimitRequestBytes, 49392123904)
    }
}
